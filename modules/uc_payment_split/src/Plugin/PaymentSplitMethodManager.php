...
namespace Drupal\uc_payment_split\Plugin;
 ...
 */
class PaymentSplitMethodManager extends DefaultPluginManager {
  ...
  public function createFromOrder(OrderInterface $order) {
    return PaymentSplitMethod::load($order->getPaymentMethodId())->getPlugin();
  }
